...
var rootCmd = &cobra.Command{
	...
	Long:  "mood-music detects your mood via webcam and auto-curates YouTube Music tracks through mpv.",
...
var configureCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println("mood-music configuration")
		fmt.Println("========================")
...
func init() {
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default ~/.config/mood-music/config.toml)")
...
var exportCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		dbPath := homeDir + "/.local/share/mood-music/history.db"
...
var setupCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		fmt.Println()
		fmt.Println("mood-music is a local desktop app for macOS and Linux.")
		...
		fmt.Println("Run: cd mood-engine && python -c \"from ytmusicapi import YTMusic; YTMusic.setup(filepath='~/.config/mood-music/headers_auth.json')\"")
...
var historyCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := os.Stat(dbPath); err != nil {
			...
			fmt.Println("History will be created after your first mood-music session.")
			return nil
		}
		...
		fmt.Println("mood-music history")
		fmt.Println("==================")
