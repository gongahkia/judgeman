"""
Django settings for Dorso backend.
"""
...
INSTALLED_APPS = [
    ...
    # Local apps
    'dorso_api.apps.tracking',
    'dorso_api.apps.problems',
]
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'dorso_api.apps.problems.utils.custom_exception_handler',
}
...
LEETCODE_CACHE_TTL = 604800  # 7 days
